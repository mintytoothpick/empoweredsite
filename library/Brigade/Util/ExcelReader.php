...
require_once 'InvalidExcelFileException.php';
...
class Spreadsheet_Excel_Reader {
    ...
    function Spreadsheet_Excel_Reader($file='', $store_extended_info=true, $outputEncoding='') {
        ...
        if ($file != "") {
        	if (!is_readable($file)) {
        	   throw new InvalidExcelFileException('The file is not readable');	
        	}
            $this->read($file);
        }
    }
    ...
    function read($sFileName) {
        ...
        if ($res === false) {
            ...
            if ($this->_ole->error == 1) {
                // bad file
                throw new InvalidExcelFileException('The filename ' . $sFileName . ' is not readable');
            }
